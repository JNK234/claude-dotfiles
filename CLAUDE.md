...
## SBT and Scala Compilation

- Doctor Biz handles sbt compilation separately and will report any errors or issues
- NEVER run `sbt compile` or other sbt commands unless explicitly asked
- Wait for compilation feedback from Doctor Biz before proceeding with fixes