            ...
            >
              <div className="px-8 py-10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-4 text-xl font-semibold text-darkBlue">McKinsey Healthcare AI Report</h3>
                </div>
                ...
                <div className="mt-6">
                  <a href="#" className="text-darkBlue hover:text-yellow font-medium flex items-center">
                    Read More
            ...
            >
              <div className="px-8 py-10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-4 text-xl font-semibold text-darkBlue">
            ...
            >
              <div className="px-8 py-10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-4 text-xl font-semibold text-darkBlue">Physician AI Preferences Survey</h3>
                </div>
                <p className="text-gray-600 leading-relaxed">
